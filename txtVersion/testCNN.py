...
def test_DCNN(dataset='testbmpData.txt',params_file='params.pkl',nkerns=[5,10]):
    ...
    layer0_input = x.reshape((data_num,1,28,28))
    layer0 = LeNetConvPoolLayer(
        input =  layer0_input,
        params_W = layer0_params[0],
        params_b = layer0_params[1],
        image_shape=(data_num,1,28,28),
    ...
    layer1 = LeNetConvPoolLayer(
        ...
        image_shape=(data_num,nkerns[0],12,12),
