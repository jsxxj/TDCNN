...
def test_CNN(dataset='mnist.pkl.gz',params_file='CNN_params.pkl'):
    ...
    layer0_input = x.reshape((10000,1,28,28)) 
    layer0 = LeNetConvPoolLayer(
                                input = layer0_input, 
                                params_W = layer0_params[0],
                                params_b = layer0_params[1],
                                image_shape = (10000,1,28,28),
    ...
    layer1 = LeNetConvPoolLayer(
                                ...
                                image_shape = (10000,N_filters_0,12,12),
