...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
                 activation=T.tanh,dropout_p=0.5):
        self.input = input
        ...
        def dropoutFromLayer(rng, layer, p):
        ...
        self.output = dropoutFromLayer(rng, self.out, p=dropout_p)
...
def save_params(param1, param2, param3, param4):
    write_file = open('Dropout_2_2_CNN_params.pkl', 'wb')
...
def test_CNN(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, batch_size=20, n_hidden=500,
